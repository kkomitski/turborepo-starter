...
import TrustpilotWidgetMicro from "@/components/_unused/widgets/TrustpilotWidgetMicro";
  ...
  return (
    <section className="Module">
      <div className="relative overflow-hidden bg-white text-navy-100">
        ...
        {/* Foreground Image */}
        {data.fields.image &&
          data.fields.image.fields.asset &&
          data.fields.image.fields.mobileVariant && (
            <picture>
              <source
                media="(max-width: 767px)"
                srcSet={
                  addHttps(
                    data.fields.image.fields.mobileVariant.fields.file.url
                  ) ?? defaultMobilePlatformImg
                }
              />
              <img
                className={cn(
                ...
                src={
                  addHttps(data.fields.image.fields.asset.fields.file.url) ??
                  defaultPlatformImg
                }
                height={
            ...
            <div className="flex flex-col items-center">
              ...
              {data.fields.features && (
                <div className="flex flex-col gap-2 md:flex-row">
                  {renderComponents(data.fields.features, undefined, [
                    "nButton",
                  ])}
                </div>
              )}
