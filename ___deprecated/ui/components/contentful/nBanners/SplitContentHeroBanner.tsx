...
const SplitContentHeroBanner = ({ content, debug }: { content: any; debug: any }) => {
  ...
  return (
    <>
      <section className="relative" {...addDataAttributes(debug)}>
          ...
          <div className="flex lg:w-1/2 lg:pr-12">
            <div className="-ml-6 lg:max-w-3xl xl:max-w-lg">
              ...
              <div className="space-y-6 pl-9">
                ...
                {enableTrustpilot && <TrustpilotWidgetMicro className="-ml-7" />}
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Mobile Image */}
        {/* {data.fields.backgroundImage && data.fields.backgroundImage.fields.mobileVariant && (
          <Image
            className="h-full w-full object-cover object-right-bottom lg:hidden"
            alt=""
            width={data.fields.backgroundImage.fields.mobileVariant.fields.file.details.image.width}
            height={data.fields.backgroundImage.fields.mobileVariant.fields.file.details.image.height}
