const LearnPageTryTheseNext = ({ links }: { links: { title: string; subtitle: string; url: string }[] }) => {
  return (
    <div className="mt-12 space-y-6">
      ...
      {links.map((link: any, index: number) => {
        return (
          <div key={index}>
            <a href={link.url} className="mb-0 flex items-center gap-x-2 text-xl font-semibold no-underline ">
